<%-- 
    Document   : Home
    Created on : Aug 8, 2019, 8:28:19 PM
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="panel panel-primary">
									...
									<a href="${pageContext.request.contextPath}/adminProduct/getAllUser.htm">
							...
							<div class="col-lg-3 col-md-6">
								<div class="panel panel-green">
									...
									<a href="${pageContext.request.contextPath}/adminProduct/getAllFeeback.htm">
										<div class="panel-footer">
											<span class="pull-left">View Details</span>
											<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
											<div class="clearfix"></div>
							...
							<div class="col-lg-3 col-md-6">
								<div class="panel panel-yellow">
									...
									<a href="${pageContext.request.contextPath}/adminProduct/getAllOrder.htm">
										<div class="panel-footer">
											<span class="pull-left">View Details</span>
											<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
											<div class="clearfix"></div>
