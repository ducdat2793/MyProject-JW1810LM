<%-- 
    ...
    Created on : Oct 5, 2019, 10:32:57 PM
                                        ...
                                        <div class="lbl-cnt"> <span class="lbl">Hiển thị</span>
                                            <div class="fld inline">
                                                <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                    ...
                                                    <ul role="menu" class="dropdown-menu">
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=1">1</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=2">2</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=3">3</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=4">4</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=5">5</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=6">6</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=7">7</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=8">8</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=9">9</a></li>
                                                        <li role="presentation"><a href="${pageContext.request.contextPath}/padging/getDataByPaggingDrop.htm?page=${page}&size=12">10</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <!-- /.fld --> 
