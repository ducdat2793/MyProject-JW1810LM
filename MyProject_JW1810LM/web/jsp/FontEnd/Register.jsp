<%-- 
    Document   : Register
    Created on : Sep 6, 2019, 4:33:51 PM
        ...
        <jsp:include page="Header.jsp"></jsp:include>
            ...
            <section class="page-account">
                <div class="container"> 
                    ...
                    <f:form accept-charset='UTF-8' action="${pageContext.request.contextPath}/homeFontEnd/register.htm" id='customer_register' commandName="register" onsubmit="return validate()">
                            ...
                            <div class="userform">
                                ...
                                <div class="form-group">
                                    ...
                                    <f:input type="text" name="userName" class="input-control type_1" id="userName" path="userName" />
                                </div>
                                <div class="form-group">
