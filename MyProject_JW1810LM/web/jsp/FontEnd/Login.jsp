<%-- 
    Document   : Login
    Created on : Aug 31, 2019, 11:43:32 PM
                ...
                <div class="container"> 
                    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                        <div id="login">
                            ...
                            <f:form  action="${pageContext.request.contextPath}/homeFontEnd/fontEndLogin.htm" id='customer_login' commandName="account" onsubmit="return validate()" >
