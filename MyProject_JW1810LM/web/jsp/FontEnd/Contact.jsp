...
<html lang="en"> 
    ...
    <script>
            ...
            <section class="page-contact">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="entry-content">
                                        <p><strong>Văn phòng đại diện</strong>: JW1810LM - Hà Nội</p>

                                        <p><strong>Showroom 1</strong>: JW1810LM - Hà Nội</p>

                                        <p><strong>Showroom 2</strong>: JW1810LM - Hà Nội</p>

                                        <p><strong>Số điện thoại</strong>: 0356778127</p>

                                        <p><strong>Email</strong>: ducdat2793@gmail.com</p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                <f:form accept-charset='UTF-8' action='${pageContext.request.contextPath}/homeFontEnd/confirmFeeback.htm' id='contact' commandName="feeback" onsubmit="return validate()">
                        ...
                        <script src='../jsp/FontEnd/js/search_filter.js' type='text/javascript'></script>
                                ...
                                <c:forEach items="${listProductHot}" var="hot">
                                    <li>
                                        <a class="image" href="productDetail.htm?Id=${hot.productId}" onclick="updateView(${hot.productId})">
                                            ...
                                            <img src="/MyProject_JW1810LM/jsp/FontEnd/images/${hot.images}" title="${hot.productName}" alt="${hot.productName}">
        ...
        <script src='/../jsp/FontEnd/js/jquery.lazyload.min.js' type='text/javascript'></script> 

        <script src='..jsp/FontEnd/js/plugin_necessary.js' type='text/javascript'></script>
        <script src='../jsp/FontEnd/js/main.js' type='text/javascript'></script>
    </body>
</html>